...
export const metadata: Metadata = {
  title: "FAQ — Bikers Demand | Help & Support",
  description: "Frequently asked questions about bike compatibility filtering, delivery charges, COD, return policy, and helmet certifications at Bikers Demand Bangladesh.",
};
